    ...
    return(
        <form className='Login-form' onSubmit={handleSubmit}>
            ...
            <div className='login-display'>
                ...
                <h2>Find your way of Bussiness</h2>
                <p>Discover the best spaces for your business</p>
                </div>
                <div className='login-display-message'>
                    <div className='stars'>
                    <svg className='color-star' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-star" viewBox="0 0 16 16">
                    ...
                    <div className='main-message'>
                        <p>"We love Landingfolio! Our designers were using it for their projects, 
